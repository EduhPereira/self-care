    ...
    return (
        <Container>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <label htmlFor="username">Nome <span>{errors.username && errors.username.message}</span></label>
                ...
                <label htmlFor="passwordConfirm">Confirmar Senha <span>{errors.passwordConfirm?.message}</span></label>
                <input type="text" {...register("passwordConfirm")} />

                <button type="submit">Enviar</button>
                <p>Já tem uma conta? <span onClick={() => history.push("/login")}>Entre</span></p>
            </form>
        </Container>
    )
}